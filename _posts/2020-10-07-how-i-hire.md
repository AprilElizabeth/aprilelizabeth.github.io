...
The goal of a second opinion (or gut check) interview is to get an outside (non-team) perspective on your candidate. You might think they're great, but someone on a team you work closely with could be ringing alarm bells. It's a way to measure how they interact with & treat people who aren't in their immediate sphere.
...
- Each interviewer would pull from a premade set of questions related to real-world examples of the core values (e.g., for Integrity, Have you ever experienced a loss for doing what is right?)
...
There is no perfect candidate, because there are no perfect people. Your hiring process is also imperfect. Still, you deserve to be picky-choosy, as does your team. Within reason, of course. Rejections should be valid and based in reality. It should go without saying, you should never (and often legally cannot) reject a candidate based on a protected status or other immutable characteristic.
