...
A job _description_ might be mandatory...but so is a job _listing._ I think a good listing has the following:
...
Oh, and this is another great spot to get your team involved. I remember drafting a job listing and asking them, "would you apply for this job?" I got some great suggestions right away!
...
- Job descriptions vs. job listings, to explain the reasoning behind both
...
- Set expectations. For example, I explain that our questionnaire has 5 questions, should take no more than 2 hours, but is not time-constrained.
